...
boolean checkSanity(){
  ...
  double bearingSanity = computeInitialBearing(LATITUDES[0],LONGITUDES[0],LATITUDES[NUMBER_OF_WAYPOINTS-1],LONGITUDES[NUMBER_OF_WAYPOINTS-1]);
  double finalSanity = computeFinalBearing(LATITUDES[0],LONGITUDES[0],LATITUDES[NUMBER_OF_WAYPOINTS-1],LONGITUDES[NUMBER_OF_WAYPOINTS-1]);
...
double computeDistanceAndBearing(double lat1, double lon1,
 ...
 double computeInitialBearing(double lat1, double lon1,
        double lat2, double lon2) {
        // Based on http://www.ngs.noaa.gov/PUBS_LIB/inverse.pdf
        // using the "Inverse Formula" (section 4)
      ...
      double initialBearing = atan2(cosU2 * sinLambda,
  ...
  double computeFinalBearing(double lat1, double lon1,
        double lat2, double lon2) {
        // Based on http://www.ngs.noaa.gov/PUBS_LIB/inverse.pdf
        // using the "Inverse Formula" (section 4)
    ...
    double finalBearing = (double) atan2(cosU1 * sinLambda,
